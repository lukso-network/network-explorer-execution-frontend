...
const FRONT_VERSION_URL = `https://github.com/lukso-network/network-explorer-execution-frontend/tree/${ config.UI.footer.frontendVersion }`;
const FRONT_COMMIT_URL = `https://github.com/lukso-network/network-explorer-execution-frontend/commit/${ config.UI.footer.frontendCommit }`;
