...
| NEXT_PUBLIC_UP_API_URL                   | `string`                                                                                         | LUKSO UP API URL used for getting various UP data                                                                                                              | -                                                                                                                                                                                                                                                                                                                                                                            | -             | `https://api.universalprofile.com` |
